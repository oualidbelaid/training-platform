...
export const mockTestimonialDTOs: TestimonialDTO[] = [
  {
    ...
    quote_ar: 'اكتسب مديرونا الثقة والوضوح خلال الأسابيع الأولى بعد التدريب. فريق تعليمي محترف للغاية.',
  ...
  },
  {
    ...
    quote_en:
      'A tailored approach with trainers who genuinely understand our teams’ challenges.',
  ...
  },
  {
    ...
    quote_ar: 'جعل البرنامج مفاهيم كانت لا تزال نظرية إلى حد كبير بالنسبة لفرقنا التشغيلية ملموسة فعلاً.',
  ...
  },
  {
    ...
    quote_en:
      'A training that immediately changed how our HR teams conduct their interviews.',
  ...
  },
  {
    ...
    quote_en:
      'Simple, directly applicable tools for both internal and external communication.',
